...
tmux send-keys -t $SESSION_NAME:0.1 "sleep 5 && export PYTHONPATH=~/src/AI-Demo/llava/llava-amd-radeon-demo:$PYTHONPATH && python3 ~/src/AI-Demo/llava/llava-amd-radeon-demo/llava/serve/model_worker.py --model-path liuhaotian/llava-v1.6-mistral-7b" C-m
