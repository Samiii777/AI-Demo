...
tmux send-keys -t $SESSION_NAME:0.1 "sleep 5 && export PYTHONPATH=~/src/AI-Demo/llava/llava-amd-radeon-demo:$PYTHONPATH && TORCH_BLAS_PREFER_HIPBLASLT=0 python3 ~/src/AI-Demo/llava/llava-amd-radeon-demo/llava/serve/model_worker.py --load-4bit --model-path liuhaotian/llava-v1.6-34b" C-m
